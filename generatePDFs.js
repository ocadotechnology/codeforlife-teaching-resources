...
async function generatePDFFromLink(page, title, link) {
  ...
  await page.pdf({
    ...
    footerTemplate: `<p style="font-size: 10px; width: 100%; padding: 10px 50px; font-family:'Source Sans Pro'; border-top: 2px solid black;">
...
;(async () => {
  ...
  let worksheets = await page.$$eval("a", as =>
    as.map(a => {
